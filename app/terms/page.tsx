      ...
      <main className="flex-1 max-w-4xl mx-auto px-6 py-12 md:py-16 w-full space-y-12">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-6 pb-8 border-b border-slate-200">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-3xl font-black text-slate-900 tracking-tight">الشُّروط والأحكام</h1>
              <p className="text-sm text-slate-500 font-bold mt-1">تطبيق شَريك لإدارة الأعمال والماليَّة</p>
            </div>
          </div>
        ...
        <div className="bg-blue-50/50 border border-blue-100 p-6 rounded-3xl text-center space-y-2">
          <p className="text-sm text-blue-800 font-bold">بمتابعة تشغيل وإنشاء حسابك، فإنك تعبر صراحة عن موافقتك الكاملة على هذه البنود.</p>
        </div>
      </main>
